...
<body data-instant-intensity="mousedown">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ asset('assets/images/job-logo.png') }}" alt="Saikat's Job Portal" style="height: 40px; width: 80">
                </a>
    ...
    <footer class="bg-dark py-3 bg-2">
        <div class="container">
            <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 Saikat Software Developer, all rights reserved</p>
        </div>
    </footer>
