        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <form action="{{ route('account.updateJob', $jobs->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" placeholder="Job Title" id="title" name="title" value="{{ $jobs->title }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6  mb-4">
                                        ...
                                        <input type="number" min="1" placeholder="Vacancy" id="vacancy" value="{{ $jobs->vacancy }}"
                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="Salary" id="salary" name="salary" value="{{ $jobs->salary }}"
                                            class="form-control">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="location" id="location" name="location" value="{{ $jobs->location }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="textarea @error('description') is-invalid  @enderror" name="description" id="description"
                                        cols="5" rows="5" placeholder="Description">{{ $jobs->description }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-control @error('experience') is-invalid @enderror"
                                        ...
                                        <option value="9" {{ $jobs->experience == 9 ? 'selected' : '' }}>9 years</option>
                                        <option value="10" {{ $jobs->experience == 10 ? 'selected' : '' }}>10 years</option>
                                        <option value="10_plus" {{ $jobs->experience == '10_plus' ? 'selected' : '' }}>10+ years</option>
                                    </select>
                                    @error('experience')
                                        <p class="invalid-feedback"> {{ $message }} </p>
                                    @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="keywords" id="keywords" name="keywords" value="{{ $jobs->keywords }}"
                                        class="form-control">
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-4 col-md-6">
                                        <label for="company_name" class="mb-2">Name<span
                                                class="req">*</span></label>
                                        <input type="text" placeholder="Company Name" id="company_name" value="{{ $jobs->company_name }}"
                                            name="company_name"
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" placeholder="Location" id="company_location" value="{{ $jobs->company_location }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Website" id="website" name="company_website" value="{{ $jobs->company_website }}"
                                        class="form-control">
                                </div>
                            </div>
